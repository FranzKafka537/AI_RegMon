...
brevo_email_send <- function(email_body, subject, from_email, to_email_string) {
  ...
  tryCatch({
    ...
    email_data <- list(
      sender = list(name = "RegMon Service", email = from_email),
...
<h1 style="color: #2c3e50; font-size: 22px; text-align: center; margin-bottom: 20px;">RegMon-Service: Regulatorik-Update</h1>
